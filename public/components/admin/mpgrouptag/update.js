	...
	template: `
		<el-dialog title="修改" width="800px" class="icon-dialog" :visible.sync="show" @open="open" :before-close="closeForm" append-to-body>
			<el-form :size="size" ref="form" :model="form" :rules="rules" :label-width=" ismobile()?'90px':'16%'">
				<el-row >
					<el-col :span="24">
						<el-form-item label="群标签名称" prop="name">
				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="群组" prop="role_type">
							<el-tree class="tree-border" @check="checkStrictly" :data="options" show-checkbox ref="menu" node-key="access"  :default-checked-keys="form.access" :check-strictly="strictly" empty-text="暂无数据" :props="defaultProps"></el-tree>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
		...
		submit(){
			this.$refs['form'].validate(valid => {
				if(valid) {
					...
					axios.post(base_url + '/Mpgrouptag/update',this.form).then(res => {
