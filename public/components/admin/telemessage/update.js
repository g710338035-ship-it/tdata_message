	...
	template: `
		<el-dialog title="修改" width="600px" class="icon-dialog" :visible.sync="show" @open="open" :before-close="closeForm" append-to-body>
			<el-form :size="size" ref="form" :model="form" :rules="rules" :label-width=" ismobile()?'90px':'16%'">
				<el-row >
					<el-col :span="24">
						<el-form-item label="选择机器人" prop="bot_id">
				...
				<el-row >
					<el-col :span="24">
						<el-form-item label="关键词" prop="word">
							<el-input  v-model="form.title" autoComplete="off" clearable  placeholder="请输入违禁词"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
	...
	methods: {
		...
		submit(){
			this.$refs['form'].validate(valid => {
				if(valid) {
					this.loading = true
					axios.post(base_url + '/Telemessage/update',this.form).then(res => {
