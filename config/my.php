...
return [
	...
	'nocheck'			=> ['/admin/Login/verify','/admin/Login/index','/admin/Login/mato','/admin/Login/logout','/admin/Base/getMenu','/admin/Index/index','/admin/Upload/upload','/admin/Upload/createFile'],	//不需要验证权限的url
	'error_log_code'	=> 500,					//写入日志的状态码
	
	'password_secrect'	=> 'vueadmin',			//密码加密秘钥
	...
	//阿里云短信配置
	'ali_sms_accessKeyId'		=> 'LTAI4Fjisddj7tALfdXRxLB',				//阿里云短信 keyId	
	'ali_sms_accessKeySecret'	=> 'Wy5isYVqtT0g7ZLYoePK6m2QjZ8Dc',	//阿里云短信 keysecret
	...
	//阿里云oss配置
	'ali_oss_accessKeyId'		=> 'LTAI4Fjisdd7tALfdXRxLB',						//阿里云短信 keyId	
	'ali_oss_accessKeySecret'	=> 'Wy5isYVqtT0g7eLYoePK6m2QjZ8Dc',					//阿里云短信 keysecret
	'ali_oss_endpoint'			=> 'http://i.whpj.vip',							//建议填写自己绑定的域名
	'ali_oss_bucket'			=> 'vueadmin',							//阿里bucket
	
	//七牛云oss配置
	'qny_oss_accessKey' 		=> 'bm1sR9bx0F5HK7KYRtAhZMJ8zOxb-HCGYx5pJU',  //access_key
	'qny_oss_secretKey' 		=> 'YrRaySbqu7M1PIzZHOgMT0ObUdb7GBPRiYa7Lq',     //secret_key
	...
	'mini_program'			=> [
		...
		'secret' => '23d7191f74762197b835d',		//小程序secret
	],
	
	//公众号配置
	'official_accounts'		=> [
		'app_id'        => 'wxa2c835664852',												//公众号appid
		'secret'		=> '2d7ef1dbdccd9e5e744',									//公众号secret
		'token'			=> 'chengdie',
	],
