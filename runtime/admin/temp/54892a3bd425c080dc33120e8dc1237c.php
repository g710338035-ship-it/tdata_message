<?php /*a:2:{s:66:"/www/wwwroot/tdata.tgbota.top/app/admin/view/uploadfile/index.html";i:1760172476;s:66:"/www/wwwroot/tdata.tgbota.top/app/admin/view/common/container.html";i:1729069940;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8" />
...
<el-table :row-class-name="rowClass" @selection-change="selection"  @row-click="handleRowClick"  row-key="uploadfile_id"  :header-cell-style="{ background: '#eef1f6', color: '#606266' }" v-loading="loading"  ref="multipleTable" border class="eltable" :data="list"  style="width: 100%">
	<el-table-column align="center" type="selection" width="42"></el-table-column>
	<el-table-column align="center" type = '' property="uploadfile_id" label="编号" show-overflow-tooltip width="70">
	</el-table-column>
	<el-table-column align="center"  property="title" label="标题" show-overflow-tooltip width="">
	</el-table-column>
	
	<el-table-column align="center"  property="file" label="单文件" show-overflow-tooltip width="">
	...
	<el-table-column :fixed="ismobile()?false:'right'" label="操作" align="center" width="180">
		<template slot-scope="scope">
			<div v-if="scope.row.uploadfile_id">
				<el-button v-if="checkPermission('/admin/Uploadfile/update.html','<?php echo implode(",",session("admin.access")); ?>','<?php echo session("admin.role_id"); ?>',[1])" size="mini" icon="el-icon-edit" type="primary" @click="update(scope.row)" >修改</el-button>
				<el-button v-if="checkPermission('/admin/Uploadfile/delete.html','<?php echo implode(",",session("admin.access")); ?>','<?php echo session("admin.role_id"); ?>',[1])" size="mini" icon="el-icon-delete" type="danger" @click="del(scope.row)" >删除</el-button>
			</div>
		</template>
	</el-table-column>
</el-table>
...
<script src="/components/admin/uploadfile/add.js?v=<?php echo rand(1000,9999)?>"></script>
<script src="/components/admin/uploadfile/update.js?v=<?php echo rand(1000,9999)?>"></script>
<script src="/components/admin/uploadfile/detail.js?v=<?php echo rand(1000,9999)?>"></script>
<script>
new Vue({
	el: '#app',
	components:{
